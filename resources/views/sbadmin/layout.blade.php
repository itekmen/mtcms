...
<head>
	...
	<meta name="author" content="murattanriover@gmail.com">
	<title>
		@section('title')
		@show
	</title>
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu dropdown-user">
					<li><a href="{{url('settings/users/data/profile')}}"><i class="fa fa-gear fa-fw"></i> Ayarlar</a></li>
					<li class="divider"></li>
					<li><a href="{{url('auth/logout')}}"><i class="fa fa-sign-out fa-fw"></i> Çıkış</a></li>
				</ul>
				<!-- /.dropdown-user -->
